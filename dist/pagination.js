  ...
  return {
    ...
    link: function link($scope) {
      ...
      function refresh() {
        ...
        if (allPages === $scope.vm.currentPage && $scope.totalItems < option.pageSize * allPages) {
          if ($scope.vm.currentPage * option.pageSize < $scope.totalItems) {
            toNumber = number + Math.abs($scope.totalItems - $scope.vm.currentPage * option.pageSize);
          } else {
